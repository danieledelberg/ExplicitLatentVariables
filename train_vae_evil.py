...
def main(args):
    ...
    if args.tilt is None:
        ...
        if args.lazy:
            ...
            # ADD EVIL DATA
            #print('no evil data')
            print('importing noisy evil data')
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for minibatch in data_generator:
            ...
            loss, gen_loss, kld = train_batch(model, lattice, y, x, yt, rot, tran, optim, beta, args.beta_control, tilt, ctf_params=ctf_param, yr=yr, use_amp=args.amp)
        ...
        if args.checkpoint and epoch % args.checkpoint == 0:
            ...
            # DANIEL SAVE
            my_z = '{}/my_rotated_z{}'.format(args.outdir, epoch)
            model.eval()
            with torch.no_grad():
                # DANIEL Z EVAL
